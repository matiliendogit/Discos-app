...
/****** Object:  Database [DISCOS_DB]    Script Date: 5/5/2024 7:28:43 PM ******/
DROP DATABASE [DISCOS_DB]
GO
...
CREATE DATABASE [DISCOS_DB]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'DISCOS_DB', FILENAME = N'D:\Programacion\Nivel 2 C# MAxi Programa\SQL\MSSQL16.SQLEXPRESS\MSSQL\DATA\DISCOS_DB.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'DISCOS_DB_log', FILENAME = N'D:\Programacion\Nivel 2 C# MAxi Programa\SQL\MSSQL16.SQLEXPRESS\MSSQL\DATA\DISCOS_DB_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
